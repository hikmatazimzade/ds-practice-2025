...
class SuggestionsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.InitOrder = channel.unary_unary(
                ...
                response_deserializer=suggestions__pb2.InitResponse.FromString,
...
def add_SuggestionsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'InitOrder': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=suggestions__pb2.InitResponse.SerializeToString,
            ),
...
class SuggestionsService(object):
    ...
    def InitOrder(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            suggestions__pb2.InitResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
