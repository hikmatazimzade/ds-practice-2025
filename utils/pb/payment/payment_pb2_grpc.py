...
class PaymentServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Commit = channel.unary_unary(
                ...
                request_serializer=payment__pb2.TransactionId.SerializeToString,
                response_deserializer=payment__pb2.Empty.FromString,
                _registered_method=True)
...
def add_PaymentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Commit': grpc.unary_unary_rpc_method_handler(
                    servicer.Commit,
                    request_deserializer=payment__pb2.TransactionId.FromString,
                    response_serializer=payment__pb2.Empty.SerializeToString,
            ),
...
class PaymentService(object):
    ...
    def Commit(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/payment.PaymentService/Commit',
            payment__pb2.TransactionId.SerializeToString,
            payment__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
